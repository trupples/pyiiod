...
Python implementation of an IIOD 1.0 protocol server to allow for flexible
programatic emulated context definitions. Somewhat compatible with the libiio
python bindings :)
...
Run this and connect to the iio context `ip:localhost:10101`!
